        ...
        <section class="mb-8">
            ...
            <div class="relative">
                <div id="genres-list" class="flex overflow-x-scroll scroll-hide-native pb-2 space-x-4">
                    ...
                    $category_images = [
                        'Fantasy' => 'assets/images/yellow-book-4995 4.png',
                        'Classic' => 'assets/images/yellow-book-4995 30.png',
                        'Political Science' => 'assets/images/yellow-book-4995 5.png',
                        'Science Fiction' => 'assets/images/yellow-book-4995 3.png',
                    ];
                    ...
                    if ($result_categories && $result_categories->num_rows > 0) {
                        while($row = $result_categories->fetch_assoc()) {
                            ...
                            // O link AQUI APONTA PARA A PÁGINA DE LISTAGEM FILTRADA (category-list.php)
